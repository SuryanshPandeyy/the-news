...
import { HomeMobileNewsStack } from "@/components/editorial/home-mobile-news-stack";
...
import { getArticlesPaginated, getHomeFeed, getHomeHeaderBannerSlides } from "@/lib/queries/articles";
...
export default async function HomePage() {
  ...
  const [feed, headerSlides, mobileNews, locale] = await Promise.all([
    getHomeFeed(),
    getHomeHeaderBannerSlides(5),
    getArticlesPaginated({ page: 1, pageSize: 10, status: "published" }),
    getLocale(),
  ]);
  ...
  return (
    <div className="w-full">
      <HomeMobileNewsStack articles={mobileNews.items} />
